...
int main (void){
	...
	*/
	...
	while (1){
		...
		Driver_USART1.Receive(tab_receive,40); //on a besoin de : 2 octets pour l'angle et deux pour la distance, le premier est pour vférifier si une résolution a été faite.
